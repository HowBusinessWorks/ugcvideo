...
const PromptTemplates = ({ onTemplateClick }: PromptTemplatesProps) => {
  return (
    <div className="py-12 sm:py-16 md:py-24 bg-muted/30">
          ...
          {templates.map((template) => {
            ...
            return (
              <button
                ...
                className={`rounded-xl p-4 sm:p-6 hover:shadow-xl transition-all duration-300 border text-left group cursor-pointer ${
                  isCustom
