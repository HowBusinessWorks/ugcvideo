...
import { Video, Download, Loader2, Sparkles, AlertCircle, RefreshCw, DollarSign } from 'lucide-react';
...
export default function VideoGenerationTab() {
    ...
    const [veo3Mode, setVeo3Mode] = useState('STANDARD');
    ...
    const handleUploadCompositeImage = async (file) => {
    ...
    return (<div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <ImageDropzone onImageSelect={handleUploadCompositeImage} currentImageUrl={compositeImageUrl} onClearImage={() => setCompositeImageUrl('')} disabled={isUploadingComposite} label="Drop composite image here or click to browse" aspectRatio="3/4"/>
            ...
            <div className="space-y-2">
              ...
              <Textarea placeholder="Describe the video motion and actions..." value={videoPrompt} onChange={(e) => setVideoPrompt(e.target.value)} rows={4} maxLength={500}/>
              <p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-2 pt-2 border-t">
              ...
              <ImageDropzone onImageSelect={handleUploadProductImage} currentImageUrl={productImageUrl} onClearImage={() => setProductImageUrl('')} disabled={isUploadingProduct} label="Drop product image here or click to browse" aspectRatio="4/3"/>
              <p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-2">
              ...
              <Select value={veo3Mode} onValueChange={(value) => setVeo3Mode(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
        ...
        <Card>
          ...
          <CardContent>
            {isGenerating && generationStartTime && (<div className="aspect-[9/16] bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg flex items-center justify-center p-8">
                <div className="w-full max-w-sm">
                  <LoadingProgress assetType="video" mode={veo3Mode} startTime={generationStartTime}/>
                </div>
              </div>)}
            ...
            {generatedVideo && !isGenerating && !failedGeneration && (<div className="space-y-4">
                <video src={generatedVideo.url} controls className="w-full rounded-lg" style={{ aspectRatio: aspectRatio.replace(':', '/') }}>
            ...
            {!isGenerating && !generatedVideo && !failedGeneration && (<div className="aspect-[9/16] bg-gray-50 rounded-lg flex items-center justify-center">
