...
import { User, Download, Loader2, Upload, AlertCircle, RefreshCw, DollarSign } from 'lucide-react';
...
export default function PersonGenerationTab({ template, onTemplateUsed }: PersonGenerationTabProps) {
  ...
  const [generatedPerson, setGeneratedPerson] = useState<{ url: string; id: string } | null>(null);
  ...
  const validateForm = (): string | null => {
    if (mode === 'EASY') {
      ...
      for (const field of requiredFields) {
        if (!personFields[field as keyof typeof personFields]) {
      ...
      <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label>Mode</Label>
              <Select value={mode} onValueChange={(value: 'EASY' | 'ADVANCED') => setMode(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
        ...
        <Card>
          ...
          <CardContent>
            ...
            {generatedPerson && !isGenerating && !failedGeneration && (
              <div className="space-y-4">
                <img
                  src={generatedPerson.url}
            ...
            {!isGenerating && !generatedPerson && !failedGeneration && (
