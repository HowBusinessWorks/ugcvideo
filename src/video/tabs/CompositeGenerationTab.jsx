...
import { Image, Download, Loader2, AlertCircle, RefreshCw, DollarSign } from 'lucide-react';
...
export default function CompositeGenerationTab() {
    ...
    const [generatedComposite, setGeneratedComposite] = useState(null);
    ...
    const handleUploadPersonImage = async (file) => {
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <ImageDropzone onImageSelect={handleUploadPersonImage} currentImageUrl={personImageUrl} onClearImage={() => setPersonImageUrl('')} disabled={isUploadingPerson} label="Drop person image here or click to browse" aspectRatio="3/4"/>
            ...
            <div className="space-y-2">
              ...
              <Textarea placeholder="Describe how the person should interact with the product (optional)..." value={compositePrompt} onChange={(e) => setCompositePrompt(e.target.value)} rows={3} maxLength={300}/>
              <p className="text-xs text-muted-foreground">
          ...
          <CardContent>
            {isGenerating && generationStartTime && (<div className="aspect-[3/4] bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg flex items-center justify-center p-8">
                <div className="w-full max-w-sm">
                  <LoadingProgress assetType="composite" startTime={generationStartTime}/>
                </div>
              </div>)}
            ...
            {generatedComposite && !isGenerating && !failedGeneration && (<div className="space-y-4">
                <img src={generatedComposite.url} alt="Generated composite" className="w-full rounded-lg"/>
            ...
            {!isGenerating && !generatedComposite && !failedGeneration && (<div className="aspect-[3/4] bg-gray-50 rounded-lg flex items-center justify-center">
